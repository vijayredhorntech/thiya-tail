 <div class="w-full flex">
     <div class="w-[30%] px-2 lg:block md:block sm:hidden hidden min-h-scree max-h-screen overflow-y-auto overscroll-none">
         <div class="w-full bg-gray-100 py-4 border-b-[2px] border-b-gray-200 flex justify-center">
             <span class="my-auto text-[22px] font-bold font-['Jost', sans-serif]">You May Also Like</span>
         </div>
            ...
            <div class="w-full grid grid-cols-1 gap-4 p-4">
                <div class="w-full lg:rounded-3xl md:rounded-3xl sm:rounded-3xl rounded-lg overflow-hidden">
                    <div class="w-full relative overflow-hidden">
                        <a href="">
                            <img class="w-full" src="https://thehimalayanfarm.in/storage/313/conversions/23-optimized.webp" alt="">

                        </a>
                        <a href="">
                            <img class="w-full absolute top-0 left-0 opacity-0 hover:opacity-100" id="productImg1" src="https://thehimalayanfarm.in/storage/314/conversions/27-optimized.webp" alt="">

                        </a>
                        <div class="font-bold lg:text-[15px] md:text-[15px] sm:text-[12px] text-[10px] text-white bg-[#008973] px-12 rotate-45 py-1 absolute lg:top-[20px] md:top-[20px] sm:top-[15px] top-[10px] lg:right-[-55px] md:right-[-55px] sm:right-[-50px]  right-[-50px]" style="border-bottom: dotted white 2px">
                            10.00% OFF
                        </div>
                    </div>
                    <div class="flex flex-col lg:w-[75%] md:w-[75%] sm:w-[75%] w-[100%] p-2 ">
                        <h4 class="font-sans">5Kg</h4>
                        <h4 class=" font-semibold font-sans lg:text-[18px] md:text-[18px] sm:text-[18px] text-[16px]  hover:text-[#2B96CC]" id="productName1">
                            <strong>
                    ...
                    <div class="flex lg:flex-col md:flex-col sm:flex-col flex-row text-right justify-end px-2 pt-4 pb-2  font-['Jost', sans-serif]">
                    ...
                    <div class="grid lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-2 grid-cols-1">
                        <div class="w-full flex justify-center bg-[#018472] border-white  lg:border-r-2 lg:border-b-0 md:border-b-0 sm:border-b-0 md:border-r-2 sm:border-r-2 border-b-2  ">
                            <button class="text-white font-semibold hover:bg-yellow-500 lg:text-[15px] md:text-[12px] text-[15px]  transition ease-in-out delay-150 p-1">
          ...
          <div class="w-full p-4">
                  ...
                  <div class="w-full flex p-6">
                      ...
                      <div class="w-[60%] p-4">
                          ...
                          <div class="w-full  px-2 pt-4 pb-2  font-['Jost', sans-serif]">
                              <span class="text-[#018472] lg:text-[18px] md:text-[18px] sm:text-[18px] text-[15px] ">Product Quantity</span>
                          </div>
                          <div class=" flex flex-row px-2  pb-2">
                                  <button class="bg-gray-200 lg:px-4 md:px-4 sm:px-2 px-2  lg:py-2 md:py-2 sm:py-1 py-1 text-[#018472] font-bold text-[15px]">-</button>
                                  <input type="text" value="1" class="w-12 bg-gray-200 border-gray-200 border-[1px]">
                                  <button class="bg-gray-200 lg:px-4 md:px-4 sm:px-2 px-2  lg:py-2 md:py-2 sm:py-1 py-1 text-[#018472] font-bold text-[15px]">+</button>
                                  <button class="bg-gray-200 lg:px-6 md:px-6 sm:px-3 px-3 lg:py-2 md:py-2 sm:py-1 py-1 text-[#018472] font-bold text-[15px]"><i class="fa fa-trash"></i></button>
                              </div>
                          <div class="w-full  px-2 pb-2  font-['Jost', sans-serif]">
                              <span class="text-[#018472] lg:text-[18px] md:text-[18px] sm:text-[18px] text-[15px] ">Total Price:- ₹1799</span>
                          </div>
                      </div>
                  </div>
              </div>
              ...
              <div class="w-full grid grid-cols-1 gap-4 border-[2px] border-gray-200 rounded-xl mt-2 pb-4">
                  ...
                  <div class="w-full flex px-6">
                      <span class="my-auto text-[22px] font-normal font-['Jost', sans-serif]">Thiya Hearts ❤: ₹1999</span>
                      <button class="bg-[#018472] text-white text-[10px] ml-2 px-2 py-1 my-auto rounded-md">Redeem</button>
                  </div>
...
{{--                  redeem points--}}
                  <div class="px-6">
                    <div class="w-full flex flex-wrap p-6 border-[1px] border-[#018472] rounded-lg">
                        <input type="text" class="lg:w-[40%] md:w-[60%] sm:w-[100%] w-[100%] rounded-md bg-white border-[1px] border-gray-200 p-2" placeholder="Points to Redeem">
                        <button class="bg-[#018472] text-white text-[10px] ml-2 px-2 py-1 my-auto rounded-md">Redeem</button>
                    </div>
                </div>
...
{{--                  apply coupon--}}
                  <div class="px-6 flex w-full">
                      <div class="lg:w-[50%] md:w-[50%] sm:w-[100%] w-[100%] flex">
                          ...
                          <input type="text" class="w-full rounded-md bg-white border-[1px] border-gray-200 p-2" placeholder="Coupon Code / Gift Card">
                          </div>
                          <button class="bg-[#018472] text-white text-[15px] w-max h-max my-auto ml-2 px-8 py-4 ">Apply</button>
                      </div>
                  </div>
                  ...
                  <div class="px-6">
                      <div class="w-full flex flex-wrap justify-between p-6 border-[1px] border-[#018472] rounded-lg">
                          <div class=" my-auto  font-['Jost', sans-serif]">
                              <span class="text-[#018472] font-semibold lg:text-[16px] md:text-[16px] sm:text-[16px] text-[14px] "><i class="fa fa-tag"></i> Coupons</span>
                          </div>
                          <div class=" my-auto  font-['Jost', sans-serif]">
                              <span class="text-[#018472] font-semibold lg:text-[16px] md:text-[16px] sm:text-[16px] text-[14px] ">Show Coupons <i class="fa fa-sort-down"></i> </span>
                          </div>
                      </div>
                  </div>
...
{{--                  coupons card--}}
                  <div class="w-full">
                          <div class="w-full grid lg:grid-cols-4 md:grid-cols-2 sm:grid-cols-2 grid-cols-1 gap-4 px-6">
                              <div class="w-full flex flex-col px-6 bg-gradient-to-r from-[#008973] to-[#63cfbd] py-8 rounded-md  relative">
                                      <span class=" text-white mx-auto text-[17px] font-normal font-['Jost', sans-serif]">Get this order for:    ₹1999</span>
                                      <button class="w-[50%] bg-transparent text-white text-[13px] w-full h-full mx-auto px-2 py-2 mt-4 border-[1px] border-white border-dotted ">CODE</button>
                                      <button class="w-[50%] bg-white text-black font-semibold text-[13px] w-full h-full mx-auto px-2 py-2">Apply Coupon</button>
...
{{--                  checkout--}}
                  <div class="w-full flex flex-col mt-2 px-6">
                      ...
                      <div>
                          <button class="bg-[#018472] text-white py-3 px-1">Proceed to Checkout</button>
                      </div>
                  </div>
