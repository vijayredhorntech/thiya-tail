...
<x-splade-modal  >
    <div class="w-full flex">
        <div
            class="w-[30%] px-2 lg:block md:block sm:hidden hidden min-h-scree max-h-screen overflow-y-auto overscroll-none">
            ...
            <div class="w-full grid grid-cols-1 gap-4 p-4">
                <div class="w-full lg:rounded-3xl md:rounded-3xl sm:rounded-3xl rounded-lg overflow-hidden">
                    <div class="w-full relative overflow-hidden">
                        <a href="">
                            <img class="w-full"
                                 src="https://thehimalayanfarm.in/storage/313/conversions/23-optimized.webp" alt="">
                    ...
                    <div
                        class="text-[#9d9d9d] text-justify  max-h-[75px] overflow-hidden  min-h-[30px] font-normal px-2">
                    ...
                    <div
                        ...
                        <span
                            class="line-through text-[#018472] lg:text-[15px] md:text-[15px] sm:text-[15px] text-[12px] ">₹ 1,999.00</span>
                        <strong class="lg:text-[18px] md:text-[18px] sm:text-[18px] text-[15px] ml-4">₹
                            1,999.00</strong>
                    </div>
                        ...
                        <div class="w-[60%] p-4">
                            ...
                            <div class="flex flex-row  px-2 pt-4 pb-2  font-['Jost', sans-serif]">
                                <span
                                    class="line-through text-[#018472] lg:text-[15px] md:text-[15px] sm:text-[15px] text-[12px] ">₹ 1,999.00</span>
                                <span
                                    class="lg:text-[15px] md:text-[15px] sm:text-[15px] text-[12px] ml-2">₹ 1,999.00</span>
                            </div>
