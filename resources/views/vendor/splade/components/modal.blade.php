        ...
        <div class="flex min-h-full justify-center" v-bind:class="{
            ...
            <x-splade-component is="transition" child animation="fade" after-leave="modal.emitClose" animate="modal.animate" v-bind:class="{
                ...
                <x-splade-component is="dialog" panel dusk="modal-dialog">
                    <div {{ $attributes->class('bg-white dark:bg-gray-900 p-6 rounded relative') }}>
                        <div v-if="modal.closeButton" class="absolute top-0 ltr:right-0 rtl:left-0 pt-3 ltr:pr-3 rtl:pl-3">
                            <button dusk="close-modal-button" @click="modal.close" type="button" class="text-gray-400 dark:text-gray-300 hover:text-gray-500 dark:hover:text-gray-400">
